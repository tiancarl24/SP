...
<div class="boxed">
	...
	<div id="content-container">
		...
		<!--Page Title-->
		<div id="page-title">
			<h1 class="page-header text-overflow">Accounts</h1>
		</div>
		...
		<div class="panel">
			...
			<div class="panel-body">
				...
				DBClose();
				wrBtn("button","btnNewItem","Add New User","col-sm-2 Right","bluegreen");
...
<!--Add new Item Modal-->
<form method="POST" action="Function/Function-AddAccounts.php" enctype="multipart/form-data">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
						<?php
						wrInput('text','txtUsername','Username','col-lg-6');
						wrInput('Password','txtPassword','Password','col-lg-6');
						?>
					</div>
					<br>
					<div class="row">
						<?php
						wrInput('text','txtName','Fullname','col-lg-6');
						wrInput('text','txtEmail','Email','col-lg-6');
						?>
					</div>
					<br>	
					<div class="row">
						<?php
						wrInput('text','txtAddress','Address','col-lg-6');
						wrInput('date','txtBirthdate','Birthdate','col-lg-6');
						?>
					</div>
				</div>
				<br>
