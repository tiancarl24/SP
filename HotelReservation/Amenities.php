...
<div class="boxed">
	...
	<div id="content-container">
		...
		<!--Page Title-->
		<div id="page-title">
			<h1 class="page-header text-overflow">Update Amenities</h1>
		</div>
		...
		<div class="panel">
			...
			<div class="panel-body">
				...
				DBClose();
				wrBtn("button","btnUpdateAmenities","Update Amenities","col-sm-2 Right MR","orange");
				?>
			</div>
		</div>
	</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
						...
						wrInput('text','txtUpdateAmenitiesTitle','TITLE','col-lg-6');
						?>
					</div>
					<br>
					<div class="row">
						<?php
						wrInput('text','txtUpdateAmenitiesDescription','DESCRIPTION','col-lg-12');
						?>
					</div>
				</div>
				<br>
...
<script type="text/javascript">
	...
	btnUpdateAmenities.onclick = function()
	{
		...
		else
		{
			...
			{
				type: "POST",
				url: "Function/GetUpdateAmenities.php",
				data:
				{
					ctr_ID: ctr_ID
				},
				success: function(response)
				{
					...
					document.getElementById('txtUpdateAmenitiesTitle').value = res[0][1];
					document.getElementById('txtUpdateAmenitiesDescription').value = res[0][2];
				}
			});
		}
	}
